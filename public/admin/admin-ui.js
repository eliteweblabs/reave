...
const SIDEBAR_LAYOUT_TYPES = new Set([
  'email',
  'chats',
  'clients',
  'work',
...
export function syncAdminSidebarLayout(mapType) {
  const use = SIDEBAR_MQ.matches && SIDEBAR_LAYOUT_TYPES.has(mapType);
  document.body.classList.toggle('admin-sidebar-layout', use);
}
