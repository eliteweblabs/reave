...
export const IOS_ICONS = {
  ...
  /* IOS_ICONS.paw — Lucide paw-print; vet landing contact CTAs */
  paw: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.84 1.045Q6.52 17.48 4.46 16.84A3.5 3.5 0 0 1 5.5 10Z"/></svg>',
  message:
  ...
  /* IOS_ICONS.filter — Lucide list-filter; inbox sender filter */
  filter:
    '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M7 12h10"/><path d="M10 18h4"/></svg>',
  ...
  /* IOS_ICONS.info — Lucide info; inline help / Email Lab instructions */
  info:
    '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',
  ...
  /* IOS_ICONS.video — Lucide video; Meet footer tab */
  video:
    '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"/><rect x="2" y="6" width="14" height="12" rx="2"/></svg>',
};
...
function bindSwipeRowContextMenu(row, contentEl, actions, opts = {}) {
  const handler = (e) => {
    e.preventDefault();
    e.stopPropagation();
    const extra = Array.isArray(opts.contextMenuItems) ? opts.contextMenuItems : [];
    showContextMenu(e.clientX, e.clientY, [...extra, ...actions], {
