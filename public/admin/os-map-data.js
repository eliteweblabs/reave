...
const SYSTEM_NODES = [
  ...
  { id: 'sales_sheet', title: 'Audit sales sheet', sub: '/admin/sales-sheet · 3 findings · google.com Places SERP in iPhone frame · back spec docs/audit-sales-sheet-back.md', icon: '🧾', hue: 168, status: true, group: 'reave', x: 220, y: 720 },
  { id: 'documents', title: 'Document templates', sub: '/admin Documents · /api/documents · preview_document · chat thumbnails (FEATURES: documents)', icon: '📄', hue: 210, status: true, group: 'reave', x: 220, y: 880 },
...
const SYSTEM_EDGES = [
  ...
  { from: 'astro', to: 'documents', label: '/api/documents · preview_document', dashed: true },
  { from: 'dev', to: 'documents', label: 'chat thumbnails · review modal', dashed: true },
  { from: 'documents', to: 'portal', label: 'signing links', dashed: true },
  { from: 'web', to: 'documents', label: '/doc/:uid/:template', dashed: true },
