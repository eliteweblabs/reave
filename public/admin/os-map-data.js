...
const SYSTEM_NODES = [
  ...
  { id: 'sales_sheet', title: 'Audit sales sheet', sub: '/admin/sales-sheet · 2 pages · audit + services/pricing · Places miss + phone mock · dummy URL first', icon: '🧾', hue: 168, status: true, group: 'reave', x: 220, y: 720 },
...
const SYSTEM_EDGES = [
  ...
  { from: 'sales_sheet', to: 'google_places', label: 'listing + competitors', dashed: true },
