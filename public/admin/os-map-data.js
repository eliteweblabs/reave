...
const SYSTEM_NODES = [
  ...
  { id: 'wp_content', title: 'WordPress™ Connect', sub: 'Super-admin module · eliteweblabs/reave-connect (FEATURES: wordpress_content)', icon: '🔌', brand: 'wordpress', hue: 200, status: true, group: 'reave', x: 400, y: 800 },
...
const EMAIL_TRIAGE_NODES = [
  ...
  { id: 'et_sort', title: 'Junk · archive · receipt', sub: 'Hide / Archive tab · expense · why-classified', icon: '🗂️', hue: 25, status: true, group: 'et_automate', x: 1160, y: 540 },
...
const EMAIL_TRIAGE_EDGES = [
  ...
  { from: 'et_rules', to: 'et_sort', label: 'junk · archive · receipt', dashed: true },
