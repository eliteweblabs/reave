...
const SYSTEM_NODES = [
  ...
  { id: 'web_push', title: 'Web Push', sub: 'admin PWA · inbox · comments · vault · share/deck views · calendar reminders · agent memory', icon: '🔔', hue: 45, status: true, group: 'reave', x: 640, y: 120 },
