...
const SYSTEM_NODES = [
  ...
  { id: 'calcom_api', title: 'calcom-booking-api', sub: 'availability · create · list · reminders (Admin → Settings; default 15m) (FEATURES: scheduling)', icon: '📅', hue: 120, status: true, group: 'reave', x: 640, y: 520 },
  ...
  { id: 'analytic_audit', title: 'Sites', sub: 'Uptime · Plausible · GSC · GA4 · IndexNow (FEATURES: analytic_audit → uptime_monitoring)', icon: '📊', brand: 'google', hue: 145, status: true, group: 'reave', x: 640, y: 804 },
  ...
  { id: 'time_tracking', title: 'Time Tracking', sub: 'Time tab · /api/work/timer · /api/work/:slug/time · Siri start_timer / stop_timer · numbered project pick (FEATURES: time_tracking)', icon: '⏱️', hue: 88, status: true, group: 'reave', x: 220, y: 600 },
  ...
  { id: 'uptimerobot', title: 'UptimeRobot', sub: 'uptime API + webhooks (bundled with Sites / analytic_audit)', icon: '📈', hue: 70, status: true, group: 'external', x: 1160, y: 1060 },
...
const SYSTEM_EDGES = [
  ...
  { from: 'calcom_api', to: 'web_push', label: 'reminder', dashed: true },
  ...
  { from: 'analytic_audit', to: 'uptimerobot', label: 'uptime monitors', dashed: true },
...
const EMAIL_TRIAGE_NODES = [
  ...
  { id: 'et_sort', title: 'Spam · archive · delete', sub: 'Junk = spam filter only · DELETE → Deleted · archive stays Archive', icon: '🗂️', hue: 25, status: true, group: 'et_automate', x: 1160, y: 540 },
...
const EMAIL_TRIAGE_EDGES = [
  ...
  { from: 'et_rules', to: 'et_sort', label: 'spam · archive · delete', dashed: true },
