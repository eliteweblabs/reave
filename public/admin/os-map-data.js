...
const SYSTEM_NODES = [
  ...
  { id: 'sales_sheet', title: 'Audit sales sheet', sub: '/admin/sales-sheet · 3 findings from terribleness cascade · Places miss + phone mock', icon: '🧾', hue: 168, status: true, group: 'reave', x: 220, y: 720 },
