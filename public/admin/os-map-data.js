...
const SYSTEM_NODES = [
  ...
  { id: 'resend', title: 'Resend', sub: 'inbound webhook · outbound compose attachments + sent CID restore · scheduled/portal', icon: '✉️', brand: 'resend', hue: 330, status: true, group: 'external', x: 1160, y: 580 },
