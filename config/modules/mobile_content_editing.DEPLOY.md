---
feature: mobile_content_editing
defaultStatus: request
stage: 3
---

# Mobile Content Editing (bolt-on CMS)
...
- Attach the editor to the existing site
- First pages / fields they can change from a phone
- Invoice REΛVE setup separately
