import { e as createComponent, m as maybeRenderHead, r as renderTemplate, f as createAstro, h as addAttribute, k as renderHead, l as renderSlot, n as renderComponent, s as spreadAttributes, o as defineScriptVars, p as renderScript } from '../chunks/astro/server_B52fyPM5.mjs';
import 'piccolore';
import 'clsx';
/* empty css                                 */
...
}, "/Users/4rgd/Astro/reave-1/node_modules/lucide-astro/dist/.Layout.astro", void 0);
...
}, "/Users/4rgd/Astro/reave-1/node_modules/lucide-astro/dist/Mic.astro", void 0);
...
const $$VoiceChatButton = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$VoiceChatButton;
  const {
    publicKey = "1c0e5ddf-59db-4ff7-898a-2c9e631116c3",
    assistantId = "22bcc946-16bd-47cd-8625-9a6a715b2c63",
    position = "center-bottom",
    enableVoiceRecognition = undefined                                                     === "true",
    voiceProfileId = "",
    assistantOverrides = {},
    userId,
  ...
  return renderTemplate(_a || (_a = __template(["", '<div id="vapi-widget-container"', ' data-astro-cid-fxhydyzz> <button id="vapi-voice-button" class="vapi-voice-button" aria-label="Start voice chat" title="Click to speak with our AI assistant" data-astro-cid-fxhydyzz> <!-- Toggle switch track --> <span class="toggle-track" data-astro-cid-fxhydyzz></span> <!-- Toggle switch thumb --> <span class="toggle-thumb" data-astro-cid-fxhydyzz> <!-- Microphone icon (active/listening state) --> ', ' <!-- Loading spinner (connecting state) --> <div id="loading-spinner" class="loading-spinner" style="display: none;" data-astro-cid-fxhydyzz> <div class="spinner-ring" data-astro-cid-fxhydyzz></div> </div> </span> </button> </div> <!-- Audio level meter - full page grayscale effect (outside container for proper fixed positioning) --> <div id="audio-level-meter" class="audio-level-meter" data-astro-cid-fxhydyzz></div> <script>(function(){', `
  ...
  let $authStore = null;
  let $userStore = null;
  let $isLoadedStore = null;

  // Initialize Clerk auth state by subscribing to stores
  async function initAuth() {
    try {
      // Try to dynamically import Clerk client stores, but fall back to window.Clerk if it fails
      console.log("Loading Clerk client stores...");
      let clerkClient = null;
      try {
        clerkClient = await import("@clerk/astro/client");
        $authStore = clerkClient.$authStore;
        $userStore = clerkClient.$userStore;
        $isLoadedStore = clerkClient.$isLoadedStore;
      } catch (importError) {
        console.warn(
          "Could not import Clerk client stores, will use window.Clerk:",
          importError
        );
        // Fall back to checking window.Clerk directly
        // Clerk integration should load it, we'll check for it in the checkClerk function
      }

      console.log("Clerk stores loaded:", {
        hasAuthStore: !!$authStore,
        hasUserStore: !!$userStore,
        hasIsLoadedStore: !!$isLoadedStore,
      });
      ...
      fetch(
        "http://127.0.0.1:7242/ingest/b70a058c-165e-4820-adda-384130e4a687",
        {
          ...
          body: JSON.stringify({
            location: "VoiceChatButton.astro:110",
            message: "Clerk stores imported",
            data: {
              hasAuthStore: !!$authStore,
              hasUserStore: !!$userStore,
              hasIsLoadedStore: !!$isLoadedStore,
      ...
      // If stores are available, use them; otherwise fall back to window.Clerk
      if ($authStore && $userStore) {
        ...
        unsubscribeAuth = $authStore.subscribe((auth) => {
          if (auth && auth.userId) {
            ...
            console.log(
              "Clerk auth store updated - user authenticated:",
              userId
            );
          } else {
            userId = null;
        ...
        fetch(
          "http://127.0.0.1:7242/ingest/b70a058c-165e-4820-adda-384130e4a687",
          {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              location: "VoiceChatButton.astro:198",
              message: "Clerk auth initialization (stores available)",
              data: {
        ...
        // Fallback: check window.Clerk directly when it loads
        console.log(
          "Clerk stores not available, will check window.Clerk directly"
        );
        const checkWindowClerk = () => {
          if (window.Clerk && window.Clerk.user) {
            userId = window.Clerk.user.id;
            isAuthenticated = true;
            console.log("Clerk user from window.Clerk:", userId);
          }
        };
        window.addEventListener("clerk-loaded", checkWindowClerk);
        ...
        fetch(
          "http://127.0.0.1:7242/ingest/b70a058c-165e-4820-adda-384130e4a687",
          {
            ...
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              location: "VoiceChatButton.astro:220",
              message: "Clerk auth initialization (fallback to window.Clerk)",
              data: {
                storesAvailable: false,
                isAuthenticated,
                userId: userId || "not set",
                hasWindowClerk: !!window.Clerk,
              },
              timestamp: Date.now(),
              sessionId: "debug-session",
              runId: "init",
      ...
      fetch(
        "http://127.0.0.1:7242/ingest/b70a058c-165e-4820-adda-384130e4a687",
        {
          ...
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            location: "VoiceChatButton.astro:195",
            message: "Clerk auth initialization error",
            data: {
              error: error.message,
              stack: error.stack,
            },
  ...
  function startAudioAnalyzer(stream) {
    try {
      ...
      function updateLevelMeter() {
        ...
        // Update full-page grayscale overlay opacity
        if (levelMeter) {
          // Map audio level (0-1) to opacity (0 - 0.8)
          const opacity = sensitiveLevel * 0.8;
          levelMeter.style.opacity = opacity.toString();
        }
          ...
          try {
            ...
            if (vapiInstance && typeof vapiInstance.on === "function") {
              ...
              vapiInstance.on("call-start-success", function () {
                ...
                // Dispatch event to enable transcripts
                window.dispatchEvent(new CustomEvent("vapi-call-start"));
              });
              ...
              vapiInstance.on("call-start", function () {
                ...
                // Dispatch event to enable transcripts (early activation)
                window.dispatchEvent(new CustomEvent("vapi-call-start"));
              });
              ...
              vapiInstance.on("message", function (data) {
                ...
                // Vapi message format: { role: "user" | "assistant", content: string, transcriptType?: "partial" | "final" }
                if (data) {
                  const text =
                    data.content ||
                    data.transcript ||
                  ...
                  const transcriptType =
                    data.transcriptType ||
                    (data.type === "transcript" ? data.transcriptType : null);
                ...
                try {
                  vapiInstance.on("transcript", function (data) {
                    ...
                    if (data) {
                      ...
                      const role = data.role || "assistant";
                      const transcriptType = data.transcriptType;
                      const isPartial = transcriptType === "partial";
              ...
              vapiInstance.on("call-end", function () {
                ...
                // Dispatch event to disable transcripts
                  ...
                  try {
                    ...
                    fetch(
                      "http://127.0.0.1:7242/ingest/b70a058c-165e-4820-adda-384130e4a687",
                      {
                        ...
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify({
                          location: "VoiceChatButton.astro:1180",
                          message: "Error getting Clerk auth state",
                          data: {
                            error: e.message,
                            hasAuthStore: !!$authStore,
                            hasUserStore: !!$userStore,
                    ...
                    "http://127.0.0.1:7242/ingest/b70a058c-165e-4820-adda-384130e4a687",
                    {
                      ...
                      body: JSON.stringify({
                        ...
                        data: {
                          ...
                          hasAuthStore: !!$authStore,
                          hasUserStore: !!$userStore,
                          authStoreHasUser: $authStore
                            ? $authStore.get()?.userId || "not set"
                            : "store not loaded",
                          userStoreHasUser: $userStore
                            ? $userStore.get()?.id || "not set"
                            : "store not loaded",
                        },
                        timestamp: Date.now(),
                        sessionId: "debug-session",
...
})();</script> `], ["", '<div id="vapi-widget-container"', ' data-astro-cid-fxhydyzz> <button id="vapi-voice-button" class="vapi-voice-button" aria-label="Start voice chat" title="Click to speak with our AI assistant" data-astro-cid-fxhydyzz> <!-- Toggle switch track --> <span class="toggle-track" data-astro-cid-fxhydyzz></span> <!-- Toggle switch thumb --> <span class="toggle-thumb" data-astro-cid-fxhydyzz> <!-- Microphone icon (active/listening state) --> ', ' <!-- Loading spinner (connecting state) --> <div id="loading-spinner" class="loading-spinner" style="display: none;" data-astro-cid-fxhydyzz> <div class="spinner-ring" data-astro-cid-fxhydyzz></div> </div> </span> </button> </div> <!-- Audio level meter - full page grayscale effect (outside container for proper fixed positioning) --> <div id="audio-level-meter" class="audio-level-meter" data-astro-cid-fxhydyzz></div> <script>(function(){', `
  // Get auth state from Clerk client-side using nanostores
  let userId = null;
  let isAuthenticated = false;
  let unsubscribeAuth = null;
...
})();</script> `])), maybeRenderHead(), addAttribute(`vapi-widget-container ${positionClasses[position]}`, "class"), renderComponent($$result, "Mic", $$Mic, { "id": "mic-icon", "class": "vapi-icon icon-active", "size": 20, "stroke-width": 2.5, "style": "display: none;", "data-astro-cid-fxhydyzz": true }), defineScriptVars({
    publicKey,
    assistantId,
    enableVoiceRecognition,
    voiceProfileId,
...
}, "/Users/4rgd/Astro/reave-1/src/components/VoiceChatButton.astro", void 0);

const $$Transcript = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="transcript-container" class="transcript-container" data-astro-cid-o33qbafv> <div id="transcript-content" class="transcript-content" data-astro-cid-o33qbafv></div> </div>  ${renderScript($$result, "/Users/4rgd/Astro/reave-1/src/components/Transcript.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/4rgd/Astro/reave-1/src/components/Transcript.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "VoiceChatButton", $$VoiceChatButton, { "position": "center-bottom", "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "Transcript", $$Transcript, { "data-astro-cid-j7pv25f6": true })} ${maybeRenderHead()}<div class="container" data-astro-cid-j7pv25f6> <!-- Fixed logo mask with moving gradient inside --> <div class="logo-mask" data-astro-cid-j7pv25f6> <div class="gradient-layer" id="gradientLayer" data-astro-cid-j7pv25f6></div> </div> <!-- Small watermark logo in bottom left --> <div class="watermark" data-astro-cid-j7pv25f6> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-astro-cid-j7pv25f6> <line x1="241.9" y1="170.2" x2="241.9" y2="318.2" fill="#fff" stroke="#fff" stroke-miterlimit="10" stroke-width="30" data-astro-cid-j7pv25f6></line> <line x1="165.6" y1="248.2" x2="314.6" y2="248.2" fill="#fff" stroke="#fff" stroke-miterlimit="10" stroke-width="30" data-astro-cid-j7pv25f6></line> <path d="M242.1,332.5v14.8c0,54.4,44.1,98.6,98.6,98.6s98.6-44.1,98.6-98.6-44.1-98.6-98.6-98.6h-12.8" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="30" data-astro-cid-j7pv25f6></path> <path d="M241.4,152.4v-45.9c0-27.7-22.4-50.1-50.1-50.1s-60.1,22.4-60.1,50.1l-1,11.4,2,19.4-12.3-2-16.4,1c-27.7,0-50.1,34.4-50.1,62.1s22.4,50.1,50.1,50.1h48.4" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="30" data-astro-cid-j7pv25f6></path> </svg> </div> </div> ` })}  ${renderScript($$result, "/Users/4rgd/Astro/reave-1/src/pages/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/4rgd/Astro/reave-1/src/pages/index.astro", void 0);

const $$file = "/Users/4rgd/Astro/reave-1/src/pages/index.astro";
const $$url = "";
