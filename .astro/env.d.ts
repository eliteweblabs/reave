declare module 'astro:env/client' {
	export const PUBLIC_CLERK_PUBLISHABLE_KEY: string | undefined;	
	...
	export const PUBLIC_CLERK_UI_URL: string | undefined;	
	export const PUBLIC_CLERK_UI_VERSION: string | undefined;	
	export const PUBLIC_CLERK_PREFETCH_UI: string | undefined;	
	...
	export const PUBLIC_CLERK_KEYLESS_DISABLED: boolean | undefined;	
}declare module 'astro:env/server' {
	export const CLERK_SECRET_KEY: string | undefined;	
