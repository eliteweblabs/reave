...
- **Receipts vs dues:** Completed payments (`payment of $…`, “you paid”) file as receipts. Stripe Capital / outstanding / upcoming minimum / failed payment language is **not** a receipt (agent label `failed_payment` or alert).
