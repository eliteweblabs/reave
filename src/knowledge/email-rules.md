...
- **Sleep mode:** Default **11 PM–7 AM** (timezone configurable). During quiet hours inbound mail is stored as **Sleep deferred** (no Claude triage, no agent alerts, no push). Owner-initiated **Siri Shortcuts** bypass sleep mode (including audit research, freeform agent prompts, and completion push). Catch-up triage runs automatically after the window ends. Adjust in Administration → **Settings** → Sleep mode.
