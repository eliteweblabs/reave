...
export const FEATURE_LABELS: Record<FeatureId, string> = {
  ...
  auto_email_response: 'Auto Email Response',
...
export const FEATURE_BLURBS: Record<FeatureId, string> = {
  ...
  video_meet: 'Self-hosted Galene rooms at meet.{domain} — branded from admin company settings, invite links via the agent.',
  ...
  auto_email_response:
    'Draft replies to inbound mail — the agent writes, you approve every send. No auto-send until you opt in later.',
