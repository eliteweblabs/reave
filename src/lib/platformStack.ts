...
export const PLATFORM_STACK: StackTech[] = [
  ...
  { slug: 'railway', name: 'Railway', color: 'var(--site-fg, #171717)', role: 'Hosting & deploy' },
  ...
  { slug: 'resend', name: 'Resend', color: 'var(--site-fg, #171717)', role: 'Email in + out' },
  ...
  { slug: 'github', name: 'GitHub', color: 'var(--site-fg, #171717)', role: 'Source control' },
  { slug: 'cloudflare', name: 'Cloudflare', color: '#F38020', role: 'DNS & edge' },
  { slug: 'caldotcom', name: 'Cal.com', color: 'var(--site-fg, #171717)', role: 'Scheduling', iconHref: '/stack/cal-com.png' },
