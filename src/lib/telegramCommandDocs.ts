...
const SECTION_DEFS: SectionDef[] = [
  {
    ...
    examples: [
      ...
      '"Delete duplicate contact uid abc-123"',
      '"Who is sarah@acme.com?"',
      '"How do I sync contacts to my iPhone?"',
      '"Set up CardDAV on my phone"',
    ],
    toolPattern: /^(resolve_contact|list_contacts|create_contact|update_contact|delete_contact)$/,
  ...
  },
  {
    ...
    examples: [
      ...
      '"/get carddav" — iOS Contacts sync setup',
      '"/get github-dev-tools" — commit files & open PRs from Telegram',
    ],
