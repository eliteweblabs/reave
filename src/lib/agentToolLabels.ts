const TOOL_LABELS: Record<string, string> = {
  ...
  exec_wp: 'Managing WordPress',
  wp_list_content: 'Listing WordPress content',
  wp_get_content: 'Reading WordPress content',
  wp_write_content: 'Updating WordPress content',
  wp_delete_content: 'Removing WordPress content',
  wp_list_media: 'Listing WordPress media',
  wp_upload_media: 'Uploading WordPress media',
  wp_set_featured_image: 'Setting WordPress featured image',
  ...
  remember: 'Saving for later chats',
  list_memories: 'Checking what I remember',
  search_memories: 'Searching saved recall',
  forget_memory: 'Forgetting a saved note',
