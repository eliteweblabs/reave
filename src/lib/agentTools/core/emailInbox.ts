            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  status: {
                    type: 'string',
                    description: 'Optional status tag (default DELETE — actually deletes). e.g. DELETE, AUTO_ARCHIVED, JUNK',
                  },
                  scope: {
                    type: 'string',
                    enum: ['personal'],
