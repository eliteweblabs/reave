...
/** Tier-1 baseline — always enabled; hidden from the public demo loader picker. Billing (004) is optional. */
export const DEMO_BASELINE_MODULE_IDS = ['001', '002', '003'] as const;
