...
`.doc-onepager::before` (`inset: 0`), tiled `center center` at 1.5% over
the original Letter scale (263.9% of 11×8.5 in), **5%** black. The pattern
fills the document; it is not painted per column.
