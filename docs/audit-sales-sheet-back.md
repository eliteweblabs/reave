...
`.doc-onepager::before` (`inset: 0`), tiled `center center` at the original
Letter scale (260% of 11×8.5 in), **15%** black. The pattern fills the
document; it is not painted per column.
