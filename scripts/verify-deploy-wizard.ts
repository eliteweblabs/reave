...
assert.equal(isPrivateFeature('microsoft_365'), true);
assert.equal(isPrivateFeature('mobile_content_editing'), true);
...
assert.equal(isPublicFeature('microsoft_365'), false);
assert.equal(isPublicFeature('google_business_profile'), false);
assert.equal(isPublicFeature('apple_business_connect'), false);
assert.equal(isPublicFeature('domain_registration'), false);
assert.equal(isPublicFeature('business_phone'), false);
assert.equal(isPublicFeature('mobile_content_editing'), false);
