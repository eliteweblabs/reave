...
assert.equal(demoModuleIdForFeature('domain_registration'), '041');
assert.equal(demoModuleIdForFeature('business_phone'), '042');
assert.equal(demoModuleIdForFeature('mobile_content_editing'), '043');
