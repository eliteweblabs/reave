...
PUBLIC_SITE_DOMAIN="${PUBLIC_SITE_DOMAIN:-lux.cleaning}"
...
set_var OWNER_EMAIL "felicia@lux.cleaning"
set_var OWNER_FIRST_NAME "Felicia"
set_var OWNER_LAST_NAME "Tracy"
set_var OWNER_PHONE "$VAPI_PHONE"
set_var ADMIN_USERNAME "Felicia,felicia@lux.cleaning"
set_var VAPID_SUBJECT "mailto:felicia@lux.cleaning"
set_var PUBLIC_CLERK_ALLOW_SIGN_UP "false"
