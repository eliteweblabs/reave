...
const SEED: SeedItem[] = [
  ...
  { slug: 'portfolio-barbers-edge-featured', file: 'public/images/portfolio/barbers-edge-featured.webp', alt: "A barber at The Barber's Edge working a beard under the ring light" },
