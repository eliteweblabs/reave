...
- **Floor plans:** Often in MLS listing photos, appraiser sketches, or uploaded project docs — consider reave.app **Documents** integration
...
- [ ] Link property results to reave.app **Contacts** / **Projects** by address
