...
Baseline modules **001–004** (`client_portal`, `web_handoff`, `portal_assistant`, `billing`) plus **036** (`email_signature`) are always enabled on tier-1 demos and are **not shown** in the public `/demo-loader` picker.
...
| 035 | `materials_pricing` | Materials pricing (Home Depot) |
| 036 | `email_signature` | Email signature |
