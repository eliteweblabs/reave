...
| `GITHUB_TOKEN` | Ops / official reave.app PAT. Optional on clients. Never copy this host token to a client. |
| `GITHUB_REPO` | App / Railway service repo (reave.app). **Not** the client website target. |
